...
# characters.
project_name = "id-only-model-sql-error"
...
deployment_bucket_name              = "id-only-model-sql-error-deployment-3488123"
public_storage_bucket_name          = "id-only-model-sql-error-public-storage-3488123"
private_storage_bucket_name         = "id-only-model-sql-error-private-storage-3488123"
public_storage_bucket_name_staging  = "id-only-model-sql-error-public-storage-staging-3488123"
private_storage_bucket_name_staging = "id-only-model-sql-error-private-storage-staging-3488123"